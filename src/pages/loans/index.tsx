...
export function LoanListPage(props: LoanListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getLoans({
        ...
        order: params.order,
        searchTermKeys: ['loan_number.contains', 'loan_type.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'loan_number', header: 'Loan Number', accessorKey: 'loan_number' },
    { id: 'loan_type', header: 'Loan Type', accessorKey: 'loan_type' },
