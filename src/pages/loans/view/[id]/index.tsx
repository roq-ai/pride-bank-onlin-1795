            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('loan', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/loans/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Loan Number" text={data?.loan_number} />

                <FormListItem label="Loan Type" text={data?.loan_type} />
