...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Pride-Bank Online`}</title>

        <meta
          name="description"
          content="Welcome to Pride-Bank Online - Your one-stop platform for seamless digital banking, encompassing account creation, transactions, loans, ATM services, and much more."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1556742111-a301076d9d18?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkaWdpdGFsJTIwYmFua2luZ3xlbnwwfHx8fDE2OTM2MTg5NDR8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Pride-Bank Online - Your one-stop platform for seamless digital banking, encompassing account creation, transactions, loans, ATM services, and much more.`}
            </Text>
            <Box
